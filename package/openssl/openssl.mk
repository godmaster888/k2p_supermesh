...
OPENSSL_PATCH = \
	$(DLINK_STORAGE)/openssl-1.0.2a-parallel-install-dirs.patch%3fid%3dc8abcbe8de5d3b6cdd68c162f398c011ff6e2d9d \
	$(DLINK_STORAGE)/openssl-1.0.2a-parallel-obj-headers.patch%3fid%3dc8abcbe8de5d3b6cdd68c162f398c011ff6e2d9d \
	$(DLINK_STORAGE)/openssl-1.0.2a-parallel-symlinking.patch%3fid%3dc8abcbe8de5d3b6cdd68c162f398c011ff6e2d9d \
	$(DLINK_STORAGE)/openssl-1.0.2d-parallel-build.patch%3fid%3dc8abcbe8de5d3b6cdd68c162f398c011ff6e2d9d
...
ifeq ($(OPENSSL_VERSION),1.0.0e)
	OPENSSL_TARGET_ARCH = musl32
else
	OPENSSL_TARGET_ARCH = generic32
endif
endif
