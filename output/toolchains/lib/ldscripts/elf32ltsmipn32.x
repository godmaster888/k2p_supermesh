...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/home/builder/buildroot_mtk/output/host/mipsel-dlink-linux-uclibc/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/home/builder/buildroot_mtk/output/host/mipsel-dlink-linux-uclibc/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
