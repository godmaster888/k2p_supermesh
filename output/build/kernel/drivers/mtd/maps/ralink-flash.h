...
#if defined (CONFIG_RT2880_FLASH_32M) && !defined(CONFIG_DUAL_IMAGE)
...
#define SAFEMODE_SIZE MTD_BOOT_PART_SIZE + MTD_FACTORY_PART_SIZE
#if defined (CONFIG_USE_CUSTOM_IMAGE1_SIZE) // if image size is set in config
#define IMAGE1_SIZE CONFIG_CUSTOM_IMAGE1_SIZE
#else
...
#elif defined (CONFIG_RT2880_FLASH_128M)
#define IMAGE1_SIZE		0x4000000
#elif defined (CONFIG_RT2880_FLASH_256M)
#define IMAGE1_SIZE		0x8000000
#endif // FLASH_SIZE
#endif // CONFIG_USE_CUSTOM_IMAGE1_SIZE
#define SAFEMODE_ADDR IMAGE1_SIZE

#define MTD_KERN2_PART_SIZE	MTD_KERN_PART_SIZE
#define MTD_KERN2_PART_OFFSET (MTD_CONFIG2_PART_OFFSET + MTD_CONFIG_PART_SIZE)
...
#define IMAGE1_SIZE		0x8000000
#elif defined (CONFIG_RT2880_FLASH_256M)
#define IMAGE1_SIZE		0x10000000
#else
#define IMAGE1_SIZE		CONFIG_MTD_PHYSMAP_LEN
#endif
#endif

#define MTD_CONFIG2_PART_OFFSET (SAFEMODE_ADDR + SAFEMODE_SIZE)
