...
static inline bool ipv6_accept_ra(struct inet6_dev *idev)
{
	 ...
	 * hybrid mode (accept_ra=2 or accept_ra=3) is enabled.
	 */
	return idev->cnf.forwarding ? ((idev->cnf.accept_ra == 2) || (idev->cnf.accept_ra == 3)) :
	    idev->cnf.accept_ra;
}
...
extern int			ip6_dst_lookup(struct net *net, struct sock *sk,
...
extern int			ip6_output(struct net *net, struct sock *sk, struct sk_buff *skb);
