...
extern int xfrm4_output(struct net *net, struct sock *sk, struct sk_buff *skb);
...
extern int xfrm6_output(struct net *net, struct sock *sk, struct sk_buff *skb);
