...
//патч patch_sdk_5.0.1.4_20160330_MT7621_hwnat_skb_headroom_patch
//меняет NET_SKB_PAD, см. 2 изменения в raether.c
//#define NET_SKB_PAD             96
//UPDATE: удалено в 5.0.2.0, оставлю свои каменты
