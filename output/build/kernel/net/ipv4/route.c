			       ...
			       u8 tos, struct net_device *dev)
{
	...
	/* farisey: #34292:
	 * while cherry-picking 61adedf3e3f1d3f032c5a6a299978d91eff6d555
	 * "route: move lwtunnel state to dst_entry",
	 * we skip 'skb_tunnel_info(skb)' part.
	 * TODO: should we call skb_dst_drop(skb) ???
	 * See f38a9eb1f77b296ff07e000823884a0f64d67b2a also.
	 */
	if (ipv4_is_multicast(saddr) || ipv4_is_lbcast(saddr))
		goto martian_source;
