...
{
	const char *end;
	int ret = 1;//farisey: avoid "uninitialized"
				 ...
				 unsigned int mediaoff, unsigned int medialen)
{
	...
	if (nf_conntrack_sip_bypass_hwnat)
		ct->mark |= (DRU_MARK_SKIP_HWNAT_RX | DRU_MARK_SKIP_HWNAT_TX);
#endif
...
#ifdef SIP_MAY_BYPASS_HWNAT
	nf_conntrack_sip_bypass_hwnat = 0;
#endif
}
...
#ifdef SIP_MAY_BYPASS_HWNAT
	nf_conntrack_sip_bypass_hwnat = 1;
#endif
	return 0;
}
