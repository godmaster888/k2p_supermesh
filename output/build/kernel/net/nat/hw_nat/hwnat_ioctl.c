...
//original
// UPDATE: #42587. moved to built-in foe_hook/api.c
extern unsigned short lan_vid;
...
#endif
{
	...
	case HW_NAT_VLAN_ID:
#if defined(CONFIG_DRU_RA_VLANS)
		dru_sysctl_data.ra_vlans.wan_vid = opt4->wan_vid;
		dru_sysctl_data.ra_vlans.lan_vid[0] = opt4->lan_vid;
		dru_sysctl_data.ra_vlans.wan_vid_be16 = htons((u16)opt4->wan_vid);
		dru_sysctl_data.ra_vlans.lan_vid_be16[0] = htons((u16)opt4->lan_vid);
#else
//original
