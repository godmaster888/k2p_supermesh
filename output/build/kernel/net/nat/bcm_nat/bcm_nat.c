...
/* farisey: #19188 на ppp0 (pppoe)
 * чуть ниже крашилось при доступе к dev->header_ops->create
 * Как оказалось из-за того, что dev->header_ops нулевой.
 * Добавил проверку. А это вот дебаг, который и дал
