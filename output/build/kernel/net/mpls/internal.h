...
#include <net/mpls.h>
#include <linux/mpls.h>		/* MPLS_LS_S_SHIFT and others */
...
#else
static inline void mpls_substack_init(struct net *net)
{
}
static inline void mpls_substack_free(struct net *net)
{
}
#endif
